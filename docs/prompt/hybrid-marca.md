...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/hybrid-marca" init --version 0.4.3 --revision 1.0.9
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/hybrid-marca" ack --id ID_RETORNADO_NA_AUDITORIA
```
...
sources:
- id: metodo
  resource: https://github.com/AgentsFlix/skills/tree/c69066dd098d9e2dc45a7fef3d8f895d9016c940/skills/hybrid-marca
...
---
type: Skill Instance
title: Estado privado de A MARCA
status: draft
agentflix:
  schema_version: 1
  skill_id: hybrid-marca
