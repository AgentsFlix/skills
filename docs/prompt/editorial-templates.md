# editorial-templates · versão para colar
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/editorial-templates" init --version 0.4.3 --revision 1.0.0
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/editorial-templates" ack --id ID_RETORNADO_NA_AUDITORIA
```
...
---
type: Playbook
title: Templates reutilizáveis da sua marca
description: Procedimento editorial autoral AgentFlix para a jornada de marca.
status: draft
generated:
  by: process:agentflix-skill-authoring
  at: 2026-09-10T01:48:21.011150+00:00
stale_after: 2026-12-09
sources:
  - id: procedimento
    resource: https://github.com/AgentsFlix/skills/tree/main/skills/editorial-templates
...
---
type: Skill Instance
title: Estado privado de Templates reutilizáveis da sua marca
status: draft
agentflix:
  schema_version: 1
  skill_id: editorial-templates
...
- `scripts/render.py (script: só no zip)`
