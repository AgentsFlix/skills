...
## Referência: references/campos-icp.json

{
  "schema_version": 1,
  "required_paths": [
    "core_icp.one_sentence_definition",
    "core_icp.icp_name",
    "core_icp.fit_percentage",
    "demographics_age.primary_range",
    "demographics_age.secondary_range",
    "demographics_age.median_age",
    "demographics_experience.years_in_field",
    "demographics_experience.background_type",
    "demographics_experience.career_progression",
    "demographics_education.minimum_level",
    "demographics_education.percentage_with_postgrad",
    "demographics_education.field_of_study_primary",
    "demographics_life_stage.description",
    "demographics_life_stage.household_type",
    "demographics_life_stage.dependents_or_commitments",
    "demographics_mindset.primary_state",
    "demographics_mindset.secondary_state",
    "demographics_mindset.limiting_belief",
    "demographics_geography.primary_market_percentage",
    "demographics_geography.secondary_markets",
    "psychographics_central_pain.what_they_say",
    "psychographics_central_pain.what_they_mean",
    "psychographics_central_pain.what_they_fear",
    "psychographics_beliefs.belief_1",
    "psychographics_beliefs.belief_2",
    "psychographics_beliefs.belief_3",
    "psychographics_beliefs.belief_4",
    "psychographics_beliefs.belief_5",
    "psychographics_mental_state.dominant_thought",
    "psychographics_mental_state.secondary_thought",
    "psychographics_mental_state.limiting_belief",
    "psychographics_consumption.hours_per_week",
    "psychographics_consumption.ratio_consumption_to_action",
    "psychographics_consumption.purchases_per_year",
    "psychographics_community.seeks_validation",
    "psychographics_community.seeks_accountability",
    "psychographics_community.seeks_belonging",
    "psychographics_community.seeks_permission",
    "pain_stack_latent.pain_1",
    "pain_stack_latent.pain_2",
    "pain_stack_latent.pain_3",
    "pain_stack_latent.pain_4",
    "pain_stack_hidden.pain_1",
    "pain_stack_hidden.pain_2",
    "pain_stack_hidden.pain_3",
    "pain_stack_hidden.pain_4",
    "pain_stack_hidden.pain_5",
    "pain_stack_hidden.pain_6",
    "pain_stack_hidden.pain_7",
    "pain_stack_hidden.pain_8",
    "pain_stack_hidden.pain_9",
    "pain_stack_hidden.pain_10",
    "pain_stack_existential.pain_1",
    "pain_stack_existential.pain_1_prevalence_percentage",
    "pain_stack_existential.pain_2",
    "pain_stack_existential.pain_2_prevalence_percentage",
    "pain_stack_existential.pain_3",
    "pain_stack_existential.pain_3_prevalence_percentage",
    "archetypes.archetype_1_name",
    "archetypes.archetype_1_percentage",
    "archetypes.archetype_1_core_issue",
    "archetypes.archetype_2_name",
    "archetypes.archetype_2_percentage",
    "archetypes.archetype_2_core_issue",
    "archetypes.archetype_3_name",
    "archetypes.archetype_3_percentage",
    "archetypes.archetype_3_core_issue",
    "archetypes.archetype_4_name",
    "archetypes.archetype_4_percentage",
    "archetypes.archetype_4_core_issue",
    "archetypes.archetype_5_name",
    "archetypes.archetype_5_percentage",
    "archetypes.archetype_5_core_issue",
    "motivations_action_triggers.trigger_1",
    "motivations_action_triggers.trigger_2",
    "motivations_action_triggers.trigger_3",
    "motivations_action_triggers.trigger_4",
    "motivations_action_triggers.trigger_5",
    "motivations_paralysis_triggers.trigger_1",
    "motivations_paralysis_triggers.trigger_2",
    "motivations_paralysis_triggers.trigger_3",
    "motivations_paralysis_triggers.trigger_4",
    "motivations_paralysis_triggers.trigger_5",
    "red_flags.flag_1",
    "red_flags.flag_2",
    "red_flags.flag_3",
    "red_flags.flag_4",
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/hybrid-icp" init --version 0.4.3 --revision 1.1.0
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/hybrid-icp" ack --id ID_RETORNADO_NA_AUDITORIA
```
...
sources:
- id: metodo
  resource: https://github.com/AgentsFlix/skills/tree/4d680bf841219c900f579b9925552842b0311b72/skills/hybrid-icp
...
Revisão editorial trimestral do questionário. Mudança de produto, público ou evidências de clientes dispara revisão do contexto pessoal antes desse prazo.
...
# Template Version: 1.0
# Field Count: 95 required fields (all mandatory)
...
psychographics_community:
  seeks_validation: null
  seeks_accountability: null
  seeks_belonging: null
  seeks_permission: null
  status: "INCOMPLETE"
...
---
type: Skill Instance
title: Estado privado de O CLIENTE IDEAL
status: draft
agentflix:
  schema_version: 1
  skill_id: hybrid-icp
