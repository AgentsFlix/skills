...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/hybrid-icp" init --version 0.4.3 --revision 1.0.5
...
sources:
- id: metodo
  resource: https://github.com/AgentsFlix/skills/tree/c69066dd098d9e2dc45a7fef3d8f895d9016c940/skills/hybrid-icp
