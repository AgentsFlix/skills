...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/copy-voz" init --version 0.4.3 --revision 1.0.6
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/copy-voz" ack --id ID_RETORNADO_NA_AUDITORIA
```
...
sources:
- id: metodo
  resource: https://github.com/AgentsFlix/skills/tree/c69066dd098d9e2dc45a7fef3d8f895d9016c940/skills/copy-voz
...
---
type: Skill Instance
title: Estado privado de INCONFUNDÍVEL
status: draft
agentflix:
  schema_version: 1
  skill_id: copy-voz
