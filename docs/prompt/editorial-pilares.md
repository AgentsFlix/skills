# editorial-pilares · versão para colar
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/editorial-pilares" init --version 0.4.3 --revision 1.0.0
...
```sh
python3 scripts/auditar.py --state "$HOME/.local/share/agentflix/editorial-pilares" ack --id ID_RETORNADO_NA_AUDITORIA
```
...
---
type: Playbook
title: Pilares e pautas da sua marca
...
sources:
  - id: procedimento
    resource: https://github.com/AgentsFlix/skills/tree/main/skills/editorial-pilares
...
---
type: Skill Instance
title: Estado privado de Pilares e pautas da sua marca
status: draft
agentflix:
  schema_version: 1
  skill_id: editorial-pilares
