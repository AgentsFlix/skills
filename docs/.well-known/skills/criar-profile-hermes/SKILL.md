...
description: Cria um novo profile Hermes com Codex via /device, memória inicial, skills embutidas, cron opcional e bot Telegram próprio. Use para onboarding completo de um profile novo; não use para reparar um…
license: MIT
