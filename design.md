...
8. Arte inicial reutiliza as capas existentes, com gradiente localizado para leitura, sem SVG ilustrativo novo. As imagens são decorativas e os rótulos funcionam se elas falharem. Movimento discreto de hover e zoom, desativado com movimento reduzido. Perguntas com muitas opções usam miniaturas compactas; no celular, Continuar acompanha a rolagem. O resultado mantém uma única peça com borda especial.
