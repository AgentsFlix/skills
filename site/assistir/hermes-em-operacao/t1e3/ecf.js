(function () {
  ...
  function saveChapterSummary(dashboard) {
    ...
    try{sessionStorage.setItem(chapterSummaryKey,JSON.stringify({version:1,method:'ecf-zernio-v4',axes}));}catch(_){}
  }
