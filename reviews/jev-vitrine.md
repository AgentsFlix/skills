...
Estado: **prévia local; aguardando aprovação editorial e visual**.
...
Próximos gates: José aprovar os dois rasters e o texto editorial; integrar a fonte privada; publicar este destino por PR; conferir o preview da Vercel, o deploy de produção, a capa entregue pelo Cloudflare e o CTA na página pública. Nenhuma dessas etapas foi contada como concluída.
