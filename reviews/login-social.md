...
O link mágico é a ação principal no topo do formulário; Google e GitHub aparecem abaixo do separador como alternativas, somente quando o Supabase informar que os provedores estão habilitados. O destino após login continua restrito a caminhos internos. Não há segredo de OAuth no código ou nesta revisão.
